...
public class Interface : IDisposable
{
    ...
    public Interface(ChatAlerts plugin)
    {
        ...
        Moon.PluginInterface.UiBuilder.Draw         += Draw;
        Moon.PluginInterface.UiBuilder.OpenConfigUi += ToggleVisibility;
        Moon.PluginInterface.UiBuilder.OpenMainUi   += ToggleVisibility;

        var colorSheet = Moon.GameData.Excel.GetSheet<UIColor>();
